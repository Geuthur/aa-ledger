        ...
        expected_result = [
            {
                "main_entity_id": 1001,
                "alts": [1001, 1002],
                "bounty_income": Decimal("400000.00"),
                "ess_income": Decimal("400000.00"),
                "mission_income": Decimal("0.00"),
                "incursion_income": Decimal("0.00"),
                "daily_goal_income": Decimal("0.00"),
                "citadel_income": Decimal("0.00"),
                "miscellaneous": Decimal("0.00"),
            },
            {
                "main_entity_id": 1010,
                "alts": [1010],
                "bounty_income": Decimal("100000.00"),
                "ess_income": Decimal("0.00"),
                "mission_income": Decimal("0.00"),
                "incursion_income": Decimal("0.00"),
                "daily_goal_income": Decimal("0.00"),
                "citadel_income": Decimal("0.00"),
